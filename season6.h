...
std::array<Man, NUM_MEN> ALL_MEN = {KAREEM, ANTHONY, MALCOLM, KEITH,
                                    JOE,    MICHAEL, ETHAN,   CLINTON,
                                    SHAD,   TYLER,   DIMITRI};
...
std::array<Woman, NUM_WOMEN> ALL_WOMEN = {ALIVIA, GELES,  NURYS,  ALEXIS,
                                          ZOE,    KEYANA, JADA,   UCHE,
                                          AUDREY, NICOLE, DIANDRA};
